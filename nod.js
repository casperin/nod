...
(function() {
  var Checker, Listener, Nod, NodMsg,
  ...
  Listener = (function() {
    ...
    function Listener(el, get, metric, msg) {
      ...
      this.msg = new NodMsg(this.$el, this.get, msg);
      this.events();
    }
  ...
  NodMsg = (function() {
    ...
    NodMsg.prototype.createMsg = function(msg) {
      return jQuery('<span/>', {
        'html': msg,
    ...
    NodMsg.prototype.toggle = function(status) {
      if (status) {
